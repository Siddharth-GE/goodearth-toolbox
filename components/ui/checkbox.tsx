...
export function Checkbox({
  ...
  return (
    <input
      ...
      className={cn(
        "border-border text-accent accent-accent focus-visible:ring-accent/25 size-4 shrink-0 rounded-md border transition-colors focus-visible:ring-4 focus-visible:outline-none disabled:opacity-50",
        className,
      )}
      {...props}
    />
