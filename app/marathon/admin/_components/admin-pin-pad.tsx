...
import { verifyAdminPinAction, type PinState } from "@/lib/marathon/actions";
import { useActionState } from "react";

export function AdminPinPad() {
  const [state, formAction, pending] = useActionState<PinState, FormData>(verifyAdminPinAction, undefined);
