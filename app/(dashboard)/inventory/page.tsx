...
export default async function InventoryPage({
  ...
  const hrefForPage = (target: number) => (target > 1 ? `/inventory?page=${target}` : "/inventory");

  return (
    <div className="space-y-4">
      <PageTitle
        title="Inventory"
        description="Record what arrives against a purchase order, see what each store holds, and record what goes out."
      />
