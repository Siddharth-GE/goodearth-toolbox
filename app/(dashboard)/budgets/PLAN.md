...
> `quote.ts` imports `lib/selections/views` for the space photos. That is the toolbox's oldest cross-tool code import and it is a known violation — `AUDIT.md` MOD-01. Don't copy the pattern; fixing it is on `TODO.md`.
